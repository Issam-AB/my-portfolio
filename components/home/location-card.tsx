...
const LocationCard = () => {
  ...
  const springConfig = { damping: 20, stiffness: 280 };
  const r = useFramerSpring(rotation, springConfig);
  ...
  return (
    <motion.div
      className="shadow-feature-card dark:shadow-feature-card-dark relative flex h-60 flex-col gap-6 overflow-hidden rounded-xl p-4 lg:p-6"
